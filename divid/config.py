...
class EvalConfig:
    ...
    subject_scene_max_frames: int = 5
    subject_scene_min_frames: int = 3
    ...
    geometry_shadow_method: str = "cotracker_hybrid"
    ...
    geometry_shadow_subject_inlier_ratio_threshold: float = 0.60
    ...
    mask_debug_limit_videos: int = 2
    mask_debug_limit_frames: int = 4
